// app/dog/[wcuNumber]/components/living/LivingPersonalityTraits.tsx
import { Sparkles } from 'lucide-react'

interface LivingPersonalityTraitsProps {
    specialAttributes: string | null
    favoriteActivities: string | null
    uniqueTraits: string | null
}

export default function LivingPersonalityTraits({
    specialAttributes,
    favoriteActivities,
    uniqueTraits
}: LivingPersonalityTraitsProps) {
    return (
